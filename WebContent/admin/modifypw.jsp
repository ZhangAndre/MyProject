...
<script type="text/javascript">
	...
	function updatePW(){
		...
		$.ajax({
			...
			type : "post",
			async : "true",
			data : {"action" : "updatePW", "oldPassword" : oldPassword, "newPassword" : newPassword},
			dataType : "json",
...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal col-sm-offset-3" id="modifyform" action="" method="post">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-4 col-xs-12">
					<button class="btn btn-success btn-block" onclick="updatePW();">提交</button>
				</div>
			</div>
		</form>
	</div>
